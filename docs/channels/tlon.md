...
Tlon is a decentralized messenger built on Urbit. Synth AI connects to your Urbit ship and can
...
- Thread replies: if the inbound message is in a thread, Synth AI replies in-thread.
