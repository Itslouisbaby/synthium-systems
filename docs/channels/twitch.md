...
read_when:
  - Setting up Twitch chat integration for Synth AI
title: "Twitch"
---

# Twitch (plugin)

Twitch chat support via IRC connection. Synth AI connects as a Twitch user (bot account) to receive and send messages in channels.
