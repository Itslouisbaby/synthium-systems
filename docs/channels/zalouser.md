...
read_when:
  - Setting up Zalo Personal for Synth AI
...
- On startup, Synth AI resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
