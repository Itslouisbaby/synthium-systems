---
summary: "Frequently asked questions about Synth AI setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Synth AI?](#whats-the-recommended-way-to-install-and-set-up-openclaw)
  ...
  - [How do I install Synth AI on Linux?](#how-do-i-install-openclaw-on-linux)
  - [How do I install Synth AI on a VPS?](#how-do-i-install-openclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Synth AI to update itself?](#can-i-ask-openclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run Synth AI, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Synth AI instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Synth AI on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Synth AI in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is Synth AI?](#what-is-openclaw)
  - [What is Synth AI, in one paragraph?](#what-is-openclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Synth AI](#what-are-the-top-five-everyday-use-cases-for-openclaw)
  - [Can Synth AI help with lead gen outreach ads and blogs for a SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Synth AI run tasks on a schedule or continuously in the background?](#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Synth AI saved locally?](#is-all-data-used-with-openclaw-saved-locally)
  - [Where does Synth AI store its data?](#where-does-openclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Synth AI?](#how-do-i-completely-uninstall-openclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the Synth AI browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Synth AI instances talk to each other (local + VPS)?](#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Synth AI load environment variables?](#how-does-openclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Synth AI instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Synth AI but keep it installed?](#how-do-i-completely-reset-openclaw-but-keep-it-installed)
  ...
  - [Why doesn't Synth AI reply in a group?](#why-doesnt-openclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Synth AI, Flawd, and Krill use for models?](#what-do-openclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [How do I run Synth AI in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Synth AI?](#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
...
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Synth AI to inbound DMs?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
...
This installs Synth AI **from a git checkout**, so the agent can read the code + docs and
...
### What's the recommended way to install and set up Synth AI
...
1. Install Synth AI on the new machine.
...
### How do I install Synth AI on Linux
...
### How do I install Synth AI on a VPS
...
### Can I ask Synth AI to update itself
...
No. You can run Synth AI with **API keys** (Anthropic/OpenAI/others) or with
...
Yes - via **setup-token**. Synth AI no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Synth AI can keep replying while a provider is rate-limited.
...
Synth AI supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Synth AI fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Usually no. Synth AI needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Synth AI runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Synth AI can I connect it to my MacBook Pro
...
### Can multiple people use one WhatsApp number with different Synth AI instances
...
If you run Synth AI via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Synth AI code install. Your state
...
**Synth AI-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Synth AI on a dedicated machine
...
Synth AI is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Synth AI in a VM and what are the requirements
...
### What is Synth AI in one paragraph

Synth AI is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Synth AI is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Synth AI
...
### Can Synth AI help with lead gen outreach ads and blogs for a SaaS
...
Synth AI draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Synth AI is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Synth AI when you
...
Yes. Add extra directories via `skills.load.extraDirs` in `~/.openclaw/openclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.openclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Synth AI treats as `<workspace>/skills`.
...
### Can Synth AI run tasks on a schedule or continuously in the background
...
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Synth AI can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Synth AI workspace); Synth AI treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.openclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
Synth AI memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Synth AI also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Synth AI auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Synth AI
prefers `local`.
...
### Is all data used with Synth AI saved locally

No - **Synth AI's state is local**, but **external services still see what you send them**.
...
### Where does Synth AI store its data
...
### How do I completely uninstall Synth AI
...
`workspace` to the repo root. The Synth AI repo is just source code; keep the
...
Synth AI reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.openclaw/openclaw.json`):
...
### Can the Synth AI browser run headless
...
### Can two Synth AI instances talk to each other local VPS
...
### How does Synth AI load environment variables

Synth AI reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:
...
does **not** mean your env vars are missing - it just means Synth AI won't load
...
### Is there a way to make a team of Synth AI instances one CEO and many agents
...
### How do I completely reset Synth AI but keep it installed
...
headers like `# Heading`), Synth AI skips the heartbeat run to save API calls.
...
No. Synth AI runs on **your own account**, so if you're in the group, Synth AI can see it.
...
### Why doesnt Synth AI reply in a group
...
Synth AI's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Synth AI currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
### What do Synth AI, Flawd, and Krill use for models

- **Synth AI + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Synth AI ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
Cooldowns apply to failing profiles (exponential backoff), so Synth AI can keep responding even when a provider is rate-limited or temporarily failing.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Synth AI will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Synth AI now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Synth AI uses provider-prefixed IDs like:
...
Synth AI may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `openclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
Synth AI enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `openclaw gateway --port <port>`.

### How do I run Synth AI in remote mode client connects to a Gateway elsewhere
...
Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.openclaw.*`, `openclaw-gateway-<profile>.service`, `Synth AI Gateway (<profile>)`).
...
- Windows: `schtasks /Query /TN "Synth AI Gateway (<profile>)" /V /FO LIST`
...
### I closed my terminal on Windows how do I restart Synth AI
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Synth AI assistant setup](/start/openclaw) and [Agent send](/tools/agent-send).
...
### Is it safe to expose Synth AI to inbound DMs
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Synth AI only replies to chats it receives or to explicit sends you trigger.
...
Synth AI blocks **cross-provider** messaging by default. If a tool call is bound
