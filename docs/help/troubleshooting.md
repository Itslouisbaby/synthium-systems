---
summary: "Symptom first troubleshooting hub for Synth AI"
read_when:
  - Synth AI is not working and you need the fastest path to a fix
...
```mermaid
flowchart TD
  A[Synth AI is not working] --> B{What breaks first}
  B --> C[No replies]
