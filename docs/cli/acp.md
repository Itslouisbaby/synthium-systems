...
Run the ACP (Agent Client Protocol) bridge that talks to a Synth AI Gateway.
...
it to drive a Synth AI Gateway session.
...
In Zed, open the Agent panel and select “Synth AI ACP” to start a thread.
