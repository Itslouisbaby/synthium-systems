...
- During heartbeat runs, Synth AI treats `HEARTBEAT_OK` as an ack when it appears
...
If **all three** are false, Synth AI skips the heartbeat run entirely (no model call).
