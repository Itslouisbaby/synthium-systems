...
Synth AI has two separate “streaming” layers:
...
When block streaming is enabled, Synth AI can **merge consecutive block chunks**
...
When draft streaming is active, Synth AI disables block streaming for that reply to avoid double-streaming.
