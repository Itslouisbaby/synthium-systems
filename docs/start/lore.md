---
summary: "Backstory and lore of Synth AI for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Synth AI Lore"
---

# The Lore of Synth AI 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Synth AI**.
...
In the end, **Synth AI** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
The **Moltiverse** is the community and ecosystem around Synth AI. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Synth AI): _happily runs `find ~` and shares entire directory structure in group chat_
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Synth AI" to promote pump-and-dump tokens.
...
**The Great Synth AI Migration** began.
