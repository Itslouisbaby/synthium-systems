---
summary: "Hubs that link to every Synth AI doc"
read_when:
...
<Note>
If you are new to Synth AI, start with [Getting Started](/start/getting-started).
</Note>
...
- [Synth AI assistant](/start/openclaw)
