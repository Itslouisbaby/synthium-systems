---
summary: "Use Venice AI privacy-focused models in Synth AI"
read_when:
  - You want privacy-focused inference in Synth AI
...
After setup, Synth AI shows all available Venice models. Pick based on your needs:
...
Synth AI automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
