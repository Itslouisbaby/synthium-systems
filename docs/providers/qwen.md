---
summary: "Use Qwen OAuth (free tier) in Synth AI"
read_when:
  - You want to use Qwen with Synth AI
...
If you already logged in with the Qwen Code CLI, Synth AI will sync credentials
