...
You can point Synth AI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Synth AI
...
- [Anthropic provider](/providers/anthropic) - Native Synth AI integration with Claude setup-token or API keys
