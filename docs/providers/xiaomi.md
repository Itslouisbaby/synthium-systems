---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Synth AI"
read_when:
  - You want Xiaomi MiMo models in Synth AI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Synth AI uses
