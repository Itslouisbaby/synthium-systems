---
summary: "Use Synthetic's Anthropic-compatible API in Synth AI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Synth AI registers it as the
...
Note: Synth AI's Anthropic client appends `/v1` to the base URL, so use
