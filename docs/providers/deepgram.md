...
Deepgram is a speech-to-text API. In Synth AI it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Synth AI uploads the audio file to Deepgram and injects the transcript
