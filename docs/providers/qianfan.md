---
summary: "Use Qianfan's unified API to access many models in Synth AI"
read_when:
...
3. Synth AI installed on your system
...
4. Copy the API key for use with Synth AI
...
- [Synth AI Configuration](/gateway/configuration)
