...
read_when:
  ...
  - Deciding: standalone CLI vs deep Synth AI integration
...
Recommendation: **deep integration in Synth AI**, but keep a separable core library.

### Why integrate into Synth AI?

- Synth AI already knows:
