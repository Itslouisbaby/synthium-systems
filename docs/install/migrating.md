---
summary: "Move (migrate) a Synth AI install from one machine to another"
read_when:
  - You are moving Synth AI to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating Synth AI to a new machine

This guide migrates a Synth AI Gateway from one machine to another **without redoing onboarding**.
...
### Step 1 — Install Synth AI on the new machine
...
- [Where does Synth AI store its data?](/help/faq#where-does-openclaw-store-its-data)
