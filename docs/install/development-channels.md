...
Synth AI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Synth AI also aligns
the install method:
...
When you switch channels with `openclaw update`, Synth AI also syncs plugin sources:
