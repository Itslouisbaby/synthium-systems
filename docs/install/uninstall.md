---
summary: "Uninstall Synth AI completely (CLI, service, state, workspace)"
read_when:
  - You want to remove Synth AI from a machine
...
```bash
rm -rf /Applications/Synth AI.app
```
...
Default task name is `Synth AI Gateway` (or `Synth AI Gateway (<profile>)`).
The task script lives under your state dir.

```powershell
schtasks /Delete /F /TN "Synth AI Gateway"
