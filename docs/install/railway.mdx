...
Deploy Synth AI on Railway with a one-click template and finish setup in your browser.
...
This exports your Synth AI state + workspace so you can migrate to another host without losing config or memory.
