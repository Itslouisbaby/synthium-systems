---
summary: "Install Synth AI declaratively with Nix"
read_when:
...
The recommended way to run Synth AI with Nix is via **[nix-openclaw](https://github.com/openclaw/nix-openclaw)** — a batteries-included Home Manager module.
...
Synth AI supports a **Nix mode** that makes configuration deterministic and disables auto-install flows.
...
Synth AI reads JSON5 config from `OPENCLAW_CONFIG_PATH` and stores mutable data in `OPENCLAW_STATE_DIR`.
...
```
apps/macos/Sources/Synth AI/Resources/Info.plist
```
