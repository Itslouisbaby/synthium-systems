---
summary: "Synth AI on Oracle Cloud (Always Free ARM)"
read_when:
  - Setting up Synth AI on Oracle Cloud
  - Looking for low-cost VPS hosting for Synth AI
  - Want 24/7 Synth AI on a small server
title: "Oracle Cloud"
---

# Synth AI on Oracle Cloud (OCI)

## Goal

Run a persistent Synth AI Gateway on Oracle Cloud's **Always Free** ARM tier.

Oracle’s free tier can be a great fit for Synth AI (especially if you already have an OCI account), but it comes with tradeoffs:
