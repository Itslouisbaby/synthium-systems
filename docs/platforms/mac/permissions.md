...
- Same path: run the app from a fixed location (for Synth AI, `dist/Synth AI.app`).
...
Workaround: move files into the Synth AI workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.
