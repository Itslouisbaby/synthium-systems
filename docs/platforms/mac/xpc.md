---
summary: "macOS IPC architecture for Synth AI app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# Synth AI macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → Synth AI.app → local execution.
