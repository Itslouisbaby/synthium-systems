...
This guide summarizes a sane workflow for working on the pi integration in Synth AI.
...
State lives under the Synth AI state directory. Default is `~/.openclaw`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.
