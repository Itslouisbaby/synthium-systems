# Contributing to the Synth AI Threat Model

Thanks for helping make Synth AI more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- Which parts of Synth AI are affected (CLI, gateway, channels, ClawHub, MCP servers, etc.)
...
- [Synth AI Threat Model](./THREAT-MODEL-ATLAS.md)
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Synth AI security hall of fame for significant contributions.
