...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="docs/assets/synthium-systems-logo.jpg">
        <img src="docs/assets/synthium-systems-logo.jpg" alt="Synth AI" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/Itslouisbaby/synthium-systems/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/Itslouisbaby/synthium-systems/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/Itslouisbaby/synthium-systems/releases"><img src="https://img.shields.io/github/v/release/Itslouisbaby/synthium-systems?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Synth AI** is a _personal AI assistant_ you run on your own devices.
...
# Send a message
openclaw message send --to +1234567890 --message "Hello from Synth AI"
...
Synth AI connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.
...
Synth AI can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Synth AI enforces this).
...
Synth AI was built for **Molty**, a space lobster AI assistant. 🦞
